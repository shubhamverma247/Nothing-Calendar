...
Meanwhile, continuing Pro Backlog builds on feature branches. Next local build pick: #6 Offline OCR Event Capture (on-device only, no network, no Room schema change).
